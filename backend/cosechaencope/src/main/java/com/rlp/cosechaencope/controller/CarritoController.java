...
import com.rlp.cosechaencope.service.CarritoService;
 ...
 */
@RestController
@RequestMapping("/cosechaencope/carrito")
@CrossOrigin(origins = "*")
...
public class CarritoController {
    ...
    public ResponseEntity<CarritoResponse> agregarAlCarrito(
        ...
        CarritoResponse response = carritoService.agregarACarrito(userDetails.getId(), request);
    ...
    public ResponseEntity<CarritoResponse> decrementarArticulo(
        ...
        CarritoResponse response = carritoService.decrementarArticulo(userDetails.getId(), idArticulo);
        return ResponseEntity.ok(response);
    }
