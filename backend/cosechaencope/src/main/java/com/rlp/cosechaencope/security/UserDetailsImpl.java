 ...
 * que adapta la entidad {@link com.rlp.ecommerce.model.Usuario} al modelo de Spring Security.
 *
...
public class UserDetailsImpl implements UserDetails {
     ...
     * @param tipoUsuario   Tipo de usuario (CLIENTE o PRODUCTOR)
     ...
     *   <li>"TYPE_{tipoUsuario}" para discriminar cliente o productor.</li>
     * </ul>
     *
    ...
    /**
     * @return Tipo de usuario (CLIENTE o productor)
     */
