...
/**
 * Entidad que representa un carrito de compras en el sistema Cosecha-en-Cope.
 *
 * Un carrito está asociado a un cliente y contiene una lista de detalles de carrito,
 * cada uno representando un artículo específico con su cantidad y precio.
 *
 * <p>
 * Está mapeada a la tabla {@code carrito} en el esquema {@code beerstar_schema}.
 * </p>
 *
 * <p>
