...
import com.rlp.cosechaencope.service.PedidoService;
 ...
 */
@RestController
@RequestMapping("/cosechaencope/pedidos")
@CrossOrigin(origins = "*")
@Tag(name = "Pedido", description = "Gestión de pedidos y procesamiento de compras")
public class PedidoController {
    ...
    public ResponseEntity<PedidoResponse> crear(
        ...
        PedidoResponse pedidoCreado = pedidoService.crearPedido(userDetails.getId(), metodoPago);
