...
import com.rlp.cosechaencope.security.AuthEntryPointJwt;
import com.rlp.cosechaencope.security.AuthTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET,
                        ...
                        "/manifest.json", "/favicon.ico", "/.well-known/**").permitAll()

                // API pública de autenticación y swagger
                .requestMatchers("/cosechaencope/auth/**").permitAll()
                ...
                .requestMatchers("/cosechaencope/categorias/**", "/cosechaencope/articulos/**").permitAll()
                ...
                // Por defecto, permitir acceso (rutas SSR públicas)
